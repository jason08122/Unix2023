...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 43 56             	add    BYTE PTR [rbx+0x56],al
 37a:	a7                   	cmps   DWORD PTR ds:[rsi],DWORD PTR es:[rdi]
 37b:	ca bc d4             	retf   0xd4bc
 37e:	06                   	(bad)  
 37f:	db 93 f4 c8 48 d9    	fist   DWORD PTR [rbx-0x26b7370c]
 385:	d5                   	(bad)  
 386:	bb 00 36 2f 4d       	mov    ebx,0x4d2f3600
 38b:	ba                   	.byte 0xba
...
0000000000001159 <solver>:
    ...
    1198:	48 83 c0 28          	add    rax,0x28
    119c:	48 8b 08             	mov    rcx,QWORD PTR [rax]
    119f:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    11a3:	48 83 c0 20          	add    rax,0x20
    11a7:	48 8b 10             	mov    rdx,QWORD PTR [rax]
    11aa:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    11ae:	48 83 c0 18          	add    rax,0x18
    11b2:	48 8b 00             	mov    rax,QWORD PTR [rax]
    11b5:	4c 8b 45 d8          	mov    r8,QWORD PTR [rbp-0x28]
    11b9:	48 89 c6             	mov    rsi,rax
...
0000000000002000 <_IO_stdin_used>:
    ...
    2004:	25 6c 75 0a 25       	and    eax,0x250a756c
    2009:	6c                   	ins    BYTE PTR es:[rdi],dx
    200a:	75 0a                	jne    2016 <__GNU_EH_FRAME_HDR+0x2>
    200c:	25 6c 75 0a 00       	and    eax,0xa756c
...
0000000000002050 <__FRAME_END__-0xc8>:
    ...
    20e2:	ff                   	(bad)  
    20e3:	ff 8c 00 00 00 00 45 	dec    DWORD PTR [rax+rax*1+0x45000000]
    20ea:	0e                   	(bad)  
    20eb:	10 86 02 43 0d 06    	adc    BYTE PTR [rsi+0x60d4302],al
    20f1:	02 83 0c 07 08 00    	add    al,BYTE PTR [rbx+0x8070c]
